...
$(function(){
	var maidImgs = $('#maidImgs'),
		...
		men = [{name:'Jordan Hardwick',url:"https://scontent-ord1-1.xx.fbcdn.net/hphotos-xaf1/v/t1.0-9/11150481_896871240374437_1931548533532726786_n.jpg?oh=f5f30015a1c443c470a7ddb5506e7e5c&oe=55FC61C4"},
				...
				{name:'Aaron Katz',url:"https://scontent-ord1-1.xx.fbcdn.net/hphotos-xpt1/v/t34.0-12/11185711_10204181662215892_1401264116_n.jpg?oh=cee32d653738ce3095442f429ef2de0e&oe=556C69D6"},
	...
	function renderPerson(person){
		var img = $("<div class='img-container wedding-party-img'><img src='"+person.url+"' id='img"+person.name+"' style='width:100%'></div>");
		//person.imgDom = img;
		return img;	
	};
